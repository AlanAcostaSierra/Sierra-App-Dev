...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    sierraAppAuthUserSubject.add(
      SierraAppAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SierraAppAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SierraAppAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SierraAppAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    sierraAppAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
