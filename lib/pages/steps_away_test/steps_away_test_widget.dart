...
import 'steps_away_test_model.dart';
export 'steps_away_test_model.dart';

class StepsAwayTestWidget extends StatefulWidget {
  const StepsAwayTestWidget({super.key});

  @override
  State<StepsAwayTestWidget> createState() => _StepsAwayTestWidgetState();
}

class _StepsAwayTestWidgetState extends State<StepsAwayTestWidget> {
  late StepsAwayTestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StepsAwayTestModel());
  }
