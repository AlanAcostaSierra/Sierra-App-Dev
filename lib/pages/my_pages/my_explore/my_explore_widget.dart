...
import 'my_explore_model.dart';
export 'my_explore_model.dart';

class MyExploreWidget extends StatefulWidget {
  const MyExploreWidget({super.key});

  @override
  State<MyExploreWidget> createState() => _MyExploreWidgetState();
}

class _MyExploreWidgetState extends State<MyExploreWidget>
    with TickerProviderStateMixin {
  late MyExploreModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyExploreModel());
